/********************************************************************************
 *  Group 11: Jacob Karcz, Keisha Arnold
...
/************************************* user input from CLI arguments **************************************************/
    ...
    if (algFlag == 1) {
        printf("Running MSS analysis on alg1: Enumeration Algorithm\nElements |  Time Elapsed\n------------------\n");
    }
    
    if (algFlag == 2) {
        printf("Running MSS analysis on alg2: Better Enumeration Algorithm\nElements |  Time Elapsed\n------------------\n");
    }
    
    if (algFlag == 3){
        printf("Running MSS analysis on alg3: Recursive Algorithm\nElements |  Time Elapsed\n------------------\n");
    }
    
    if (algFlag == 4) {
        printf("Running MSS analysis on Alg4: Linear Time Algorithm\nElements |  Time Elapsed\n------------------\n");
    }
